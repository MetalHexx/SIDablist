 ...
 * (`teensyrom-hardware-fork`, `Source/Teensy/MinimalBoot/Common/IO_Handlers/IOH_ASID.c`). The
 * chip's own register layout lives in `@sidablist/core` — these values are the wire protocol
 * alone.
 */
 ...
 * `slot-map.ts` for how the secondary slots get used.
 */
