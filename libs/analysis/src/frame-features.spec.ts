...
import { scanTune } from './scan-tune.js';
...
const knownFeaturesTune: SidFile = tune([
  { at: 0x1000, bytes: [RTS] },
  {
    ...
    bytes: [
      ...
      0x8d,
      0x04,
      0xd4, // LDA #$81 (noise+gate); STA $D404 (voice 1 control)
      0xa9,
      0x11,
      0x8d,
      0x0b,
      0xd4, // LDA #$11 (triangle+gate); STA $D40B (voice 2 control)
      0xa9,
      0x05,
      0x8d,
      0x15,
      0xd4, // LDA #$05; STA $D415 (filter cutoff low)
      0xa9,
      0x3c,
      0x8d,
      0x16,
      0xd4, // LDA #$3C; STA $D416 (filter cutoff high)
      0xa9,
      0xf3,
      0x8d,
      0x17,
      0xd4, // LDA #$F3; STA $D417 (resonance/routing)
      0xa9,
      0x0a,
      0x8d,
      0x18,
      0xd4, // LDA #$0A; STA $D418 (volume)
      RTS,
    ],
  },
]);
...
const voiceDetailTune: SidFile = tune([
  { at: 0x1000, bytes: [RTS] },
  {
    ...
    bytes: [
      ...
      0x8d,
      0x03,
      0xd4, // pulse width hi (low nibble only)
      0xa9,
      0x9a,
      0x8d,
      0x05,
